...
export class jpeg_download_control extends classic_preset.Control {
  constructor(
...
export function jpeg_download_control_component({ data }: { data: jpeg_download_control }) {
  return (
    <div>
      <button
...
export class jpeg_download_node extends classic_preset.Node {
    width = 250;
    height = 280;
    id: string;
    ...
    constructor(change?: (updated_node_id?: string) => void) {
        ...
        this.addControl("download", new jpeg_download_control(undefined, this.id, change));
    ...
    data(inputs: { image?: image_transport[] }) {
      ...
      const download_control = this.controls.download as jpeg_download_control;
